...
const schema: SchemaConfig = {
  ...
  type: "Person",
  name: "Krystian G.",
  description: "Full-stack developer — custom Next.js websites and web apps for businesses. SEO-ready builds, e-commerce, and B2B portals. React, TypeScript, Vercel.",
